...
#!/usr/bin/perl -wl
$input_file_1=$ARGV[0];
if( system ("perl 4_subseq.pl $input_file_1 test1_1.txt test1_1.txt.3.txt test1_1.txt.5.txt test1_1.txt.9.txt test1_1.txt.r3.txt  test1_1.txt.134.txt test1_2.txt") ){
